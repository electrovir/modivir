...
/**
 * List of origins that you allow open IN BROWSER. Navigation to origins below is possible only if
...
app.on('web-contents-created', (_, contents) => {
     ...
     *
     * Navigation is a common attack vector. If an attacker can convince the app to navigate away from
     * its current page, they can possibly force the app to open web sites on the Internet.
     *
    ...
    /**
     * Block requested unallowed permissions. By default, Electron will automatically approve all
     * permission requests.
     *
     ...
     *
     * The creation of new `webContents` is a common attack vector. Attackers attempt to convince the
     * app to create new windows, frames, or other renderer processes with more privileges than they
     * had before; or with pages opened that they couldn't open before. You should deny any unexpected
     * window creation.
     *
